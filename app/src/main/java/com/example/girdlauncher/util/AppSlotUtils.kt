...
/**
 * 配置済みのAPP SLOTウィジェット（[com.example.girdlauncher.model.WidgetPanel.APP_SLOT_ICON_ONLY]/
 * [com.example.girdlauncher.model.WidgetPanel.APP_SLOT_NAMED]）が、それぞれどのアプリを
 * 割り当てられているかをSharedPreferencesから読み込む。
 *
 * この割り当ては[com.example.girdlauncher.model.PlacedWidget.instanceId]をキーにした、
